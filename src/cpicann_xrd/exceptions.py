...
class ErrorCode(StrEnum):
    ...
    XDECOMPOSER_ASSET_MANIFEST_INVALID = "XDECOMPOSER_ASSET_MANIFEST_INVALID"
    XDECOMPOSER_ASSET_MISSING = "XDECOMPOSER_ASSET_MISSING"
    XDECOMPOSER_ASSET_HASH_MISMATCH = "XDECOMPOSER_ASSET_HASH_MISMATCH"
    XDECOMPOSER_ASSET_LICENSE_UNCONFIRMED = "XDECOMPOSER_ASSET_LICENSE_UNCONFIRMED"
